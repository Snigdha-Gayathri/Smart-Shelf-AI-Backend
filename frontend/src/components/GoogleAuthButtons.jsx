...
export default function GoogleAuthButtons({ enabled = true, mode = 'login' }) {
    ...
    return (
      <div className="space-y-3">
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-900 shadow-[0_8px_25px_rgba(15,23,42,0.2)] transition-all duration-300 ease-in-out disabled:cursor-not-allowed disabled:opacity-70"
        >
  ...
  return <GoogleAuthButtonsClerk mode={mode} />
}

function GoogleAuthButtonsClerk({ mode = 'login' }) {
